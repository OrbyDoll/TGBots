...
categor_choose_back = types.InlineKeyboardMarkup(row_width=1).add(
    ...
    types.InlineKeyboardButton(text="🕵️‍♂️SAFETY 1.0 BY PRADA💻 (техника)", callback_data='tehnica'),
    types.InlineKeyboardButton(text="🕵️‍♂️SAFETY 2.0 BY PRADA🧠 (поведение)", callback_data='povedeniye'),
    types.InlineKeyboardButton(text="🕵️‍♂️SAFETY 3.0 BY PRADA💰 (отмыв)", callback_data='otmiv'),
